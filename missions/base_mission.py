...
class BaseMission:
    ...
    def resolve_current_error(self):
        ...
        self.update_layer(side, layer_num, LayerStatus.COMPLETE, "Reparado y verificado", has_error=False)
        self.log("SUCCESS", "✓", f"¡Capa {layer_num} reparada! Reanudando misión...", layer_num)
    ...
    def complete_mission(self, summary_data: Dict[str, Any]):
        ...
        self.is_running = False
        self.log("SUCCESS", "✓", "¡Comunicación completada con éxito! Todas las capas fueron recorridas con decisiones del usuario.", None)
    ...
    def start_mission(self):
        ...
        self.is_paused = False
        self.log("INFO", "✓", f"Misión iniciada: {self.title}", None)
